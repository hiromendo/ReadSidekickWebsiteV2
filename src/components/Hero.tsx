...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-ivory-100">
      {/* Abstract geometric accents - warm coral/terracotta tones */}
      <motion.div
        ...
        className="absolute top-[15%] right-[8%] w-32 h-32 md:w-48 md:h-48 bg-coral-500 opacity-90 rounded-2xl"
      />
      ...
      <motion.div
        ...
        className="absolute top-[35%] left-[5%] w-20 h-20 md:w-28 md:h-28 bg-teal-500 opacity-80 rounded-xl"
      />
      ...
      <motion.div
        ...
        className="absolute bottom-[25%] right-[15%] w-16 h-40 md:w-20 md:h-56 bg-ochre-400 opacity-85 rounded-lg"
      />
      ...
      <motion.div
        ...
        className="absolute left-[10%] top-0 w-px h-[40%] bg-ink-800/20 origin-top"
      />
      ...
      <motion.div
        ...
        className="absolute right-0 top-[45%] w-[30%] h-px bg-ink-800/20 origin-right"
      />
            ...
            <div className="p-6 md:p-8 flex flex-col lg:flex-row gap-6">
              ...
              <div className="w-full lg:w-72 bg-ivory-50 rounded-xl border border-ink-800/10 p-4">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="font-mono text-sm text-ink-900 font-medium">{t.hero.extensionPanel}</span>
                </div>

                {/* Mode toggles */}
                <div className="flex gap-2 mb-4">
                  <button className="px-3 py-1.5 bg-teal-500 text-white text-xs font-mono rounded">{t.hero.easy}</button>
                  <button className="px-3 py-1.5 bg-ink-800/10 text-ink-700 text-xs font-mono rounded">{t.hero.medium}</button>
                  <button className="px-3 py-1.5 bg-ink-800/10 text-ink-700 text-xs font-mono rounded">{t.hero.hard}</button>
                </div>
