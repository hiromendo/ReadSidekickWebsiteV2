        ...
        >
            ...
            <div className="editorial-container relative z-10">
                ...
                <div ref={headerRef} className="mb-16 md:mb-20 max-w-3xl">
                    ...
                    >
                        <span className="editorial-label text-ivory-100/60">
                            {t.aslTranslator.comingSoon}
                        </span>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-col md:flex-row items-start md:items-center gap-4 pb-6 border-b border-ivory-100/10">
                            <div className="flex-shrink-0 w-full md:w-40">
                                <span className="font-mono text-caption text-ivory-100/50">
                                    {t.aslTranslator.traditionalPhonics}
                                </span>
                            </div>
                            <div className="flex flex-wrap items-center gap-3">
                                ...
                                <svg
                                    className="w-6 h-6 text-ivory-100/40"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                >
                        ...
                        <div className="flex flex-col md:flex-row items-start md:items-center gap-4 pb-6 border-b border-ivory-100/10">
                            <div className="flex-shrink-0 w-full md:w-40">
                                <span className="font-mono text-caption text-teal-400">
                                    {t.aslTranslator.aslApproach}
                                </span>
                            </div>
                            <div className="flex flex-wrap items-center gap-3">
                        ...
                        <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
                            <div className="flex-shrink-0 w-full md:w-40">
                                <span className="font-mono text-caption text-coral-400">
                                    {t.aslTranslator.likeKanji}
                                </span>
                            </div>
                            <div className="flex flex-wrap items-center gap-3">
