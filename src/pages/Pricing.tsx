...
const FAQ_ITEMS = [
    {
        ...
        answer: "Yes. You can cancel your subscription at any time from inside the extension. You'll keep access through the end of the current billing period.",
    },
    {
        question:
            "What's the difference between the free extension and the paid plans?",
        answer: "The Read Sidekick extension itself is free to install. The paid plans unlock Memory (saved highlights and flashcards) and one-click simplification for dense text.",
    },
    {
        question: "Why is the yearly plan cheaper?",
        answer: "Paying yearly works out to about $2.50/month — roughly two months free compared to paying monthly. If you read regularly, it's the better deal.",
    },
];
    ...
    return (
        <section className="relative py-editorial bg-ivory-100 overflow-hidden min-h-screen">
            <Helmet>
                ...
                <link
                    rel="canonical"
                    href="https://www.readsidekick.com/pricing"
                />
                ...
                <meta
                    property="og:url"
                    content="https://www.readsidekick.com/pricing"
                />
            </Helmet>
            ...
            <div className="editorial-container">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="text-center mb-16 md:mb-20">
                        ...
                        >
                            One plan, two ways to pay. Both include Memory and
                            one-click simplification for anything you read.
                        </motion.p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-20 md:mb-24">
                        ...
                        >
                            ...
                            <div className="mb-8">
                                ...
                                <p className="font-mono text-body-sm text-ink-700/50 mt-2">
                                    Just $2.50/month, billed annually. Roughly
                                    two months free.
                                </p>
                            </div>
                            <PlanFeatureList />
                    ...
                    >
                        Install the free extension to get started — you can
                        choose and manage your plan from inside Read Sidekick.
                    </motion.p>
