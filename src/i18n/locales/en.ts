...
export const en: Translations = {
  ...
  problem: {
    ...
    subtitle: '130 million U.S. adults lack adequate literacy proficiency—and it\'s holding them back.',
    stats: {
      adults: {
        stat: '130M',
        description: 'U.S. adults who lack adequate literacy proficiency',
      },
      deaf: {
        stat: '4th Grade',
        description: 'Median reading level for Deaf high school graduates',
      },
      inmates: {
        stat: '70%',
        description: 'Of inmates who cannot read above a 4th grade level',
      },
      immigrants: {
        stat: '41%',
        description: 'Of immigrant adults with the lowest levels of English literacy',
      },
    },
    economicImpact: {
      label: 'Economic Impact',
      title: 'in potential annual income',
      titleHighlight: '$2.2 trillion',
      description: 'This is the amount that could be generated by raising all U.S. adults to Level 3 literacy proficiency.',
      correlationLabel: 'Higher literacy levels directly correlate with higher income:',
      lowestLiteracy: 'Lowest literacy levels',
      highestLiteracy: 'Highest literacy levels',
      comparison: 'More than',
      comparisonHighlight: 'double',
    },
  },
